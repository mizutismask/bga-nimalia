...
class GoalRelativeAnimalsCountTestWithTie extends GameTestBase { // this is your game class defined in ggg.game.php
    ...
    /*
    3 players, tie on gorillas for first place
    */
...
$test1 = new GoalRelativeAnimalsCountTestWithTie();
$test1->testAll();
