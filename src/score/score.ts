	...
	constructor(private game: NimaliaGame, private players: NimaliaPlayer[]) {
		...
		if (!headers.childElementCount) {
			dojo.place(
				`
                <th> </th>
                <th colspan="4">${_('Round 1')}</th>
                <th colspan="4">${_('Round 2')}</th>
                <th colspan="4">${_('Round 3')}</th>
                <th colspan="5">${_('Round 4')}</th>
                <th colspan="5">${_('Round 5')}</th>
            `,
				headers
			)
			dojo.place(
		...
		players.forEach((player) => {
			...
			dojo.place(
				`<tr id="score${player.id}">
                    ...
                    <td id="score-round-1-${player.id}" class="score-number total">0</td>
                    ...
                    <td id="score-round-2-${player.id}" class="score-number total">0</td>
                    ...
                    <td id="score-round-3-${player.id}" class="score-number total">0</td>
                    ...
                    <td id="score-round-4-${player.id}" class="score-number total">0</td>
                    ...
                    <td id="score-round-5-${player.id}" class="score-number total">0</td>
                </tr>`,
				'score-table-body'
			)
		})
