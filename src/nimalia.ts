...
class Nimalia implements NimaliaGame {
	...
	public getGoalTooltip(card: Goal) {
		let tooltip = `
			<div class="nml-goal-tooltip">
				${this.getGoalDescription(card.id - 1)}
		    </div>`
		return tooltip
	}
	...
	public getGoalDescription(index) {
		switch (index) {
			...
			case 17:
				return _(
					'The player with the most gorillas gets 5 points (2nd gets 2 points). The player with the most pandas gets -5 points (2nd gets -2 points in 3/4 players games)'
				)
			case 18:
			...
			case 20:
				return _(
					'The player with the most crocodiles gets 5 points (2nd gets 2 points). The player with the fewest flamingoes gets 5 points (2nd gets 2 points in 3/4 players games)'
				)
			case 21:
