...
var Nimalia = /** @class */ (function () {
    ...
    Nimalia.prototype.getGoalTooltip = function (card) {
        var tooltip = "\n\t\t\t<div class=\"nml-goal-tooltip\">\n\t\t\t\t".concat(this.getGoalDescription(card.id - 1), "\n\t\t    </div>");
        return tooltip;
    };
    Nimalia.prototype.getGoalDescription = function (index) {
        switch (index) {
            case 0:
            ...
            case 2:
                return _('2 points per distinct rain forest area');
            case 3:
                return _('2 points per gorilla orthogonally adjacent to a lake');
            case 4:
                return _('2 points per space of your largest savannah.');
            case 5:
                return _('6 points per savanna area spanning exactly 4 spaces.');
            case 6:
                return _('4 points per 2×2 square of ice floe (a space can be part of several squares)');
            case 7:
                return _('2 points per polar bear that is part of a group of bears, and - 1 per solitary bear');
            case 8:
                return _('2 points per space of the terrain of which you have the fewest spaces in your reserve (here it’s 2×3 = 6)');
            case 9:
                return _('3, 5, 8, 13 or 21 points if your reserve completely fills a 2x2, 3x3, 4x4, 5x5, or 6x6 square');
            case 10:
                return _('3 points per row of your reserve that contains all 4 terrain types');
            case 11:
                return _('3 points per strict horizontally adjacent pair of identical animals. 3 animals don’t count');
            case 12:
            ...
            case 17:
                return _('The player with the most gorillas gets 5 points (2nd gets 2 points in 3/4 players game). <br>The player with the most pandas gets -5 points (2nd gets -2 points in 3/4 players games) <br>The score of this goal is the sum of the 2 previously mentioned points.');
            case 18:
            ...
            case 20:
                return _('The player with the most crocodiles gets 5 points (2nd gets 2 points in 3/4 players game). <br>The player with the fewest flamingoes gets 5 points (2nd gets 2 points in 3/4 players games). <br>The score of this goal is the sum of the 2 previously mentioned points.');
            case 21:
...
var ScoreBoard = /** @class */ (function () {
    ...
    ScoreBoard.prototype.highlightWinnerScore = function (playerId) {
        document.getElementById("score-round-5-".concat(playerId)).classList.add('highlight');
