...
$gameinfos = array(
    ...
    'publisher_website' => 'http://www.laboitedejeu.fr/en/',

    // Board Game Geek ID of the publisher
    'publisher_bgg_id' => 27121,
    ...
    'tie_breaker_description' => totranslate( "Player with the most animals of the same type in their reserve wins" ),
    ...
    'presentation' => array(
        totranslate("Create the best animal sanctuary. Try to build harmony between species and biomes, even if this means sacrificing parts of your sanctuary by covering them with new ones, always more beautiful…  "),
        totranslate("The goal of Nimalia is to conceive the best Animal Sanctuary along 5 rounds."),
        totranslate("Each and every turn, players will have to select the animal territories they are going to place, by drafting them (picking a card among their hand of 3 cards, and passing along the rest of them)."),
        totranslate("Each card they place will have to cover a part of their existing animal reserve.
